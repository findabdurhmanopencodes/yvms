...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('volunteer_resource_histories', function (Blueprint $table) {
            $table->id();
            $table->foreignId('volunteer_id')->nullable()->constrained('volunteers','id')->nullOnDelete()->cascadeOnUpdate();
            $table->foreignId('resource_id')->nullable()->constrained('resources','id')->nullOnDelete()->cascadeOnUpdate();
