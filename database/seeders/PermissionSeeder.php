...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name'=>'Disablity.create']);
        ...
        Permission::create(['name'=>'EducationalLevel.edit']);
        ...
        Permission::create(['name'=>'Qouta.create']);
        Permission::create(['name'=>'Qouta.store']);
        Permission::create(['name'=>'Qouta.show']);
        Permission::create(['name'=>'Qouta.edit']);
        ...
        Permission::create(['name'=>'Region.edit']);
        ...
        Permission::create(['name'=>'TrainingCenterCapacity.create']);
        Permission::create(['name'=>'TrainingCenterCapacity.store']);
        Permission::create(['name'=>'TrainingCenterCapacitq.show']);
        Permission::create(['name'=>'TrainingCenterCapacity.edit']);
        ...
        Permission::create(['name'=>'TrainingPlacement.create']);
        Permission::create(['name'=>'TrainingPlacement.store']);
        Permission::create(['name'=>'TrainingPlacement.show']);
        Permission::create(['name'=>'TrainingPlacement.edit']);
        ...
        Permission::create(['name'=>'TrainingSession.create']);
        ...
        Permission::create(['name'=>'TraininingCenter.create']);
        Permission::create(['name'=>'TraininingCenter.store']);
        Permission::create(['name'=>'TraininingCenter.show']);
        Permission::create(['name'=>'TraininingCenter.edit']);
        ...
        Permission::create(['name'=>'UserRegion.create']);
        ...
        Permission::create(['name'=>'Volunteer.edit']);
        ...
        Permission::create(['name'=>'Woreda.create']);
        Permission::create(['name'=>'Woreda.store']);
        Permission::create(['name'=>'Woreda.show']);
        Permission::create(['name'=>'Woreda.edit']);
