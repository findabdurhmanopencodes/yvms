                    ...
                    <form>
                        ...
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
                            ...
                            <h4 class="d-flex flex-center rounded-top">
                                ...
                                <span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2"> Notifications </span>
                            </h4>
                            <!--end::Title-->
                            <!--begin::Tabs-->
                                ...
                                <div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300"
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="d-flex flex-column font-weight-bold">
                                            <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg"> New 8,000 Volunters
                                                Applications </a>
                    ...
                    <ul class="navi navi-hover py-4">
                        ...
                        <li class="navi-item">
                            ...
                            <a href="#" class="navi-link">
                                ...
                                <form method="POST" class="p-0 m-0" action="{{ route('logout') }}">@csrf<button type="submit"
            ...
            @auth
                <div class="topbar-item">
                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                        ...
                        <a href="{{ route('user.show', auth()->user()->id) }}"><span
