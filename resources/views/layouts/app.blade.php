                        ...
                        <div id="kt_aside_menu" class="my-4 aside-menu" data-menu-vertical="1" data-menu-scroll="1"
                            ...
                            <ul class="menu-nav">
                                ...
                                @if (Request::route('training_session'))
                                    ...
                                    @canany(['Volunteer.index', 'Volunteer.Screen', 'Volunteer.email.unverified',
                                        'Volunteer.verified.applicant', 'Volunteer.selected'])
                                    ...
                                    @can('coFacilitator')
                                        @if (request('training_session') != null)
                                            @if (\App\Models\TrainingCenterBasedPermission::where('training_session_id', request('training_session'))->where('user_id', Auth::user()->id)->where('permission_id', \Spatie\Permission\Models\Permission::findOrCreate('coFacilitator')?->id)->first())
