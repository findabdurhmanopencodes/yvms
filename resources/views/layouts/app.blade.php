    ...
    <div class="main-container ace-save-state" id="main-container">
        ...
        <div id="sidebar" class="sidebar responsive ace-save-state">
            ...
            <ul class="nav nav-list">
                ...
                <li
                    class="{{ strpos(Route::currentRouteName(), 'user') === 0 || strpos(Route::currentRouteName(), 'permission') === 0? 'active open': '' }}">
                    <a href="#" class="dropdown-toggle">
                    ...
                    <b class="arrow"></b>
                    <ul class="submenu">
                        <li class="{{ strpos(Route::currentRouteName(), 'user.index') === 0 ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ strpos(Route::currentRouteName(), 'user.create') === 0 ? 'active' : '' }}">
            ...
            <div class="footer-inner">
                <div class="footer-content">
                    <span class="bigger-120">
                        <span class="blue bolder">Ministry Of Peace</span>
                        &copy; 2021-2022
                    </span>
