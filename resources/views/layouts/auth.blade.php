	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-row-fluid bg-white" id="kt_login">
				<!--begin::Aside-->
				<div class="login-aside d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10" style="background-color:#6993FF;">
					...
					<div class="d-flex flex-row-fluid flex-column justify-content-center">
						...
						<h3 class="font-size-h3 mb-5 text-white" style="text-align:center;"> National Youth Volunteerism  Managment System </h3>
                        <h1 class=" text-white" style="text-align:center;">Login </h1>
					</div>
					<!--end: Aside Container-->
				</div>
				<!--begin::Aside-->
