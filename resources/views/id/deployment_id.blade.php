...
@push('js')
    ...
    <script>
        $('#print_btn').on('click', function(){
            ...
            var textToAdd = document.createTextNode('MoP-FBE-00061/1');
            ...
            var textToAdd2 = document. createTextNode('Milky Seifu');
            ...
            var p = document.createElement("p");
            var s = document.createElement("strong");
            var textToAdd = document. createTextNode('Jimma');
            s.appendChild(textToAdd);
            p.appendChild(s);
            p.style.position = "relative";
            p.style.left = '126';
            ...
            var textToAddback5 = document.createTextNode('Milky Seifu Benti');
            ...
            var textToAddback9 = document.createTextNode('12/12/2014');
            ...
            var textToAddback11 = document.createTextNode('Jimma');
            ...
            var textToAddback13 = document.createTextNode('30/12/2015');
            ...
            JsBarcode(div__bar_img)
                .options({font: "OCR-B", displayValue: true, width:0.9, height: 17})
                .CODE128('MoP-FBE-00061/1', {fontSize: 10, textMargin: 2, textPosition: "top", color:'inherit'})
                .render();
