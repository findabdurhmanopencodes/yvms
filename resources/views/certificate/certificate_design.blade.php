        ...
        $('#print_btn').on('click', function(event){
            var applicants = @json($applicants);
                ...
                applicants.forEach((applicant, key) => {
                    ...
                    var textToAdd2 = document.createTextNode("MILKY SEIFU BENTI");
                    ...
                    var textToAdd3 = document.createTextNode("ግንቦት 22, 2014");
                    ...
                    var textToAdd4 = document.createTextNode("May 30, 2022");
