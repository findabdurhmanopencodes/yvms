            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="reportForm"
                        ...
                        <input type="hidden" name="reportable_type" value="{{ \App\Models\Region::class }}">
                        <input type="hidden" name="reportable_id" value="{{ $region->id }}">
                    </form>
                </div>
    ...
    <div class="card card-custom mb-2">
        <div class="card-header flex-wrap  pt-6 ">
            <div class="card-title mr-0">
                <h3 class="card-label">{{ $region->name }} Hierarchila Reports</h3>
            </div>
            <div class="card-tool">
                ...
                <tbody>
                    @foreach ($zones as $key => $zone)
                        <tr>
                            ...
                            <td>{{ $zone->name }}</td>
                            <td>
                                <a href="{{ route('session.deployment.zone.woredas', ['training_session' => Request::route('training_session')->id, 'zone' => $zone->id]) }}"
                                    class="btn btn-icon">
