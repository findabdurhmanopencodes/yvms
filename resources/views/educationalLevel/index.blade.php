            ...
            <tbody>
                ...
                @foreach ($educational_levels as $key => $educational_level)
                    ...
                    <tr>
                        <td>{{ $key + 1 }}</td>
                        <td>
                            <a>{{ $educational_levels->name }}</a>
                        </td>
                        <td>{{ $educational_levels->created_at }}</td>
                        <td class="text-right project-actions">
                            ...
                            <a class="btn btn-sm btn-danger btn-round" href="#" onclick="DeleteEducationalLevel({{ $educational_levels->id }},this);">
