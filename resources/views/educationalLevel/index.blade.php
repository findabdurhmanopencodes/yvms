@extends('layouts.app')
@section('title', 'All Educational Level')
@section('breadcrumb-list')
    <li class="active">Educational Levels</li>
@endsection
@section('breadcrumbTitle', 'Regions')
@section('breadcrumbList')
    <li class="breadcrumb-item">
        <a href="" class="text-muted">Educational Levels</a>
    </li>
@endsection
@push('js')
    <script>
        var HOST_URL = "{{ route('educational_level.index') }}";

        function deleteRegion(educationLevelId, parent) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "POST",
                        url: '/educational_level/' + educationLevelId,
                        data: {
                            "id": educationLevelId,
                            "_method": 'DELETE',
                        ...
                        success: function(data) {
                            ...
                            Swal.fire(
                                "Deleted!",
                                "Educationa Level has been deleted.",
                                "success"
                            )
                        },
                        error: function(data) {
                            if (data.status) {
                                Swal.fire("Forbidden!", "You can't delete this educational level!", "error");
                            }
                        }
                    });
                }
        ...
        var COLUMNS = [{
            ...
            },
            {
                ...
                template: function(row) {
                    var educationalLevelId = row.id;
                    return '\
                                    <div class="d-flex">\
                                                <a href="javascript:;" onclick="deleteRegion(' + educationalLevelId + ',$(this))" class="btn btn-sm btn-clean btn-icon" >\
                                                    <i class="far fa-trash"></i>\
                                                </a>\
                                                \
                                                <a href="/educational_level/' + educationalLevelId + '/edit" class="btn btn-sm btn-clean btn-icon" >\
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">List of educational level
                    <span class="text-muted pt-2 font-size-sm d-block">Educational Levels</span>
                </h3>
            </div>
            <div class="card-toolbar">
                ...
                <a href="#" class="btn btn-primary font-weight-bolder" data-toggle="modal" data-target="#exampleModal">
                 ...
                 Add New Educational Level</a>
                <form method="POST" action="{{ route('educational_level.store', []) }}">
                        @csrf
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg"  role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Add new Educational Level</h5>
