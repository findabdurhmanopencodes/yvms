...
class TraininingCenterController extends Controller
{
    ...
    public function get_attendance_data(TrainingSession $trainingSession, TraininingCenter $trainingCenter, CindicationRoom $cindicationRoom)
    {
